	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		carEventsButton.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View v) {
	        	...
	        	Intent intent = new Intent(EventsActivity.this, CarEventsActivity.class);
		...
		transportEventsButton.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View v) {
	        	...
	        	Intent intent = new Intent(EventsActivity.this, TransportEventsActivity.class);
	            startActivity(intent);
	        }
	    });
		...
		bicycleEventsButton.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View v) {
	        	...
	        	Intent intent = new Intent(EventsActivity.this, BicycleEventsActivity.class);
	            startActivity(intent);
	        }
	    });
		...
		pedestrianEventsButton.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View v) {
	        	...
	        	Intent intent = new Intent(EventsActivity.this, PedestrianEventsActivity.class);
	            startActivity(intent);
	        }
	    });
	}
